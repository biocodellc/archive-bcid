...
CREATE TABLE `identifiers` (
  ...
  `suffixPassthrough` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'indicates if we want use suffix Passthrough instead of default BCID',
  ...
  `what` text NOT NULL COMMENT 'URI describing what this is -- user specified',
  `ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'timestamp of insertion',
